...
*/
@RestController("${modelNameUpperCamel}BaseController")
...
public class ${modelNameUpperCamel}Controller {
    ...
    public Result list(@ModelAttribute TimeRangeCriteriaPageParams params, @AuthenticationPrincipal LoginUser user) {
        ...
        List<${modelNameUpperCamel}> lists = services.selectByConditionForStartPage(condition, params.getP(), params.getPs(), true);
