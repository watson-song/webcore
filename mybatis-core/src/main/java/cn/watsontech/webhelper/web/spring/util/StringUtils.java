package cn.watsontech.webhelper.web.spring.util;
...
public class StringUtils {
    ...
    public static String cleanPath(String path) {
        ...
        // "file:webhelper/../webhelper/io/Resource.class", where the ".." should just
        // strip the first "webhelper" directory while keeping the "file:" prefix.
    ...
    public static String getMapToParams(Map<String, String[]> paramMap) {
        ...
        for (Map.Entry<String, String[]> param : paramMap.entrySet()) {
            ...
            params.append(endsWithIgnoreCase(param.getKey(), "password") ? "" : paramValue);
        }
     ...
     * @return
     */
    public static <T> String mapToQueryString(Map<String, T> paramMap) {
        if (paramMap == null) {
            return "";
        }
