...
import cn.watsontech.webhelper.utils.RequestUtils;
...
//	值得一提的是，在JDK5.0中，ThreadLocal已经支持泛型，该类的类名已经变为ThreadLocal<T>。API方法也相应进行了调整，新版本的API方法分别是void set(T value)、T get()以及T initialValue()。
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        log.info("OpenApiAspect-{}.doBefore()，{}, {}", openApi.value(), RequestUtils.getIpAddress(request), requestUrl);
        ...
        AppInfo modelParams = new AppInfo();
        modelParams.setCode(apiParams.getAppid());
        AppInfo openAppinfoVo = openAppInfoService.selectFirst(modelParams);
        ...
        log.info("OpenApiAspect.doBefore 加密字符串：{}，已签名字符串：{}, 当前时间戳：{}", needSignParamString, signedString, currentTimestamp);
    ...
    public void doAfter(JoinPoint joinPoint) {
        ...
        log.info("OpenApiAspect.doAfter()，请求ID：{}", apiParams.getRequestId());
    }
    ...
    public void doAfterThrowingAdvice(JoinPoint joinPoint, Throwable exception) {
        ...
        log.info("OpenApiAspect-{}-[异常].doAfterThrowingAdvice() - requestId:{}", apiParams.getAppid(),apiParams.getRequestId());
    }
