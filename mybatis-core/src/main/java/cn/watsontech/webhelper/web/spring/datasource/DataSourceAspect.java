...
public class DataSourceAspect implements Ordered {
    ...
    @Pointcut("@annotation(cn.watsontech.webhelper.web.spring.datasource.UseDatabase)")
...
//    }
    ...
    @Pointcut("execution(public * cn.watsontech.webhelper.service.intf.BaseService.insert*(..))")
    public void bsInsertPointcut() {}
    @Pointcut("execution(public * cn.watsontech.webhelper.service.intf.BaseService.update*(..))")
    public void bsUpdatePointcut() {}
    @Pointcut("execution(public * cn.watsontech.webhelper.service.intf.BaseService.delete*(..))")
