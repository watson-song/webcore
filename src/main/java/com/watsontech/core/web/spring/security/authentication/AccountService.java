...
import com.watsontech.core.web.form.AdminRegisterForm;
import com.watsontech.core.web.spring.security.LoginUser;
import com.watsontech.core.web.spring.security.entity.Admin;
import com.watsontech.core.web.spring.security.entity.User;
import com.watsontech.core.service.AdminService;
import com.watsontech.core.service.UserService;
import com.watsontech.core.service.manually.AdminManualService;
import com.watsontech.core.service.manually.MessageManualService;
import com.watsontech.core.utils.NoHelper;
...
public class AccountService {
    ...
    private LoginUser loadAccountInfo(String conditionKey, Object conditionValue, LoginUser.Type userType, String[] selectProperties, boolean checkEnabled, boolean notFoundCheck) {
        ...
        if (conditionKey!=null&&conditionValue!=null) {
            ...
            com.watsontech.core.service.intf.Service<? extends LoginUser, Long> service = getUserService(userType);
    ...
    private com.watsontech.core.service.intf.Service<? extends LoginUser, Long> getUserService(LoginUser.Type userType) {
        switch (userType) {
            case admin:
                return adminService;
            default:
