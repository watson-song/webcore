...
import static cn.watsontech.webhelper.UploadService.UploadVendor.local;
 ...
 */
@Service
@ConditionalOnMissingClass(value = {"com.qcloud.cos.COSClient","com.obs.services.ObsClient"})
public class LocalUploadServiceImpl extends UploadService {
    ...
    @PostConstruct
    void initLocalDir() {
        Assert.isTrue(local==properties.getVendor(), "当前配置非本地磁盘存储服务");
